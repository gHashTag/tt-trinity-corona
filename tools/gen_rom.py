...
assert len(CATALOG) == 77, f"Expected 77 records, got {len(CATALOG)}"


def generate_verilog(records, output_path):
    """Generate format_rom.v with 77 records."""
    lines = []
    ...
    lines.append("// 77 records x 80 bits per specs/corona/rom_layout.t27")
    lines.append("")
...
if __name__ == "__main__":
    ...
    print("All 77 records verified: format_index_id round-trips correctly.")
