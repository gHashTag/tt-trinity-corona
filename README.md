...
| Document status | Submission-ready (18 decoders, 49 tests PASS, GDS+precheck PASS) |
...
test/                     # cocotb tests (49) + gate-level simulation (49/49 PASS)
...
| E | Conformance suite (49 cocotb + 57 formal tasks + 49 GL tests) | **Done** |
